...
import  sankeyLinkHorizontal  from './Link'
import { XYPlot, VerticalRectSeries, LabelSeries, CustomSVGSeries } from 'react-vis';
import { getAttr0Functor, getAttributeFunctor } from 'react-vis/dist/utils/scales-utils'
...
function Sankey(props) {
    ...
    console.log(AbstractSeries._getAttr0Functor);
    ...
    function getInnerDimensions(props, defaultMargins) {
        ...
        var marginProps = defaultMargins;
